        ...
        <section>
          <div className="flex items-center justify-between mb-8 px-2">
            <div className="flex items-center gap-4">
              ...
              <h2 className="text-2xl font-black text-white uppercase tracking-tighter italic">Minhas Pendências</h2>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {pendingLists.length === 0 && (
              <div className="col-span-full py-20 border-2 border-dashed border-[#1a1a1a] rounded-[2.5rem] flex flex-col items-center justify-center text-gray-700">
                ...
                <p className="text-xs font-black uppercase tracking-widest">Nada pendente no momento</p>
              </div>
            )}
          </div>
        </section>
        ...
        <section>
          <div className="flex items-center justify-between mb-8 px-2">
            <div className="flex items-center gap-4">
              ...
              <h2 className="text-2xl font-black text-white uppercase tracking-tighter italic">Finalizados</h2>
            </div>
