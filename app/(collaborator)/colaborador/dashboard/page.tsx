      ...
      {data.map((v, i) => {
        ...
        return (
          <div key={i} className="flex-1 group relative flex flex-col items-center h-full justify-end">
            ...
            />
            <div className="absolute -top-4 opacity-0 group-hover:opacity-100 transition-opacity text-[9px] text-text-main font-bold bg-background px-1 rounded border border-border z-10">
              {v}
            </div>
          </div>
        )
  ...
  return (
    <div className="h-[calc(100vh-100px)] flex flex-col gap-4 overflow-hidden p-1">
      ...
      <div className="h-16 flex flex-shrink-0 items-center gap-4">
        <div className="bg-surface border border-border rounded-xl px-5 h-full flex items-center gap-4 flex-1 min-w-0">
        ...
        <div className="bg-surface border border-border rounded-xl px-4 h-full flex items-center gap-3 flex-shrink-0">
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              className="bg-background border border-border rounded-lg px-2 py-1 text-text-main text-[10px] focus:outline-none focus:border-[#10b981]/50 [color-scheme:dark]"
            />
      ...
      <div className="flex-1 grid grid-cols-12 grid-rows-6 gap-4 min-h-0">
        ...
        <div className="col-span-3 row-span-6 grid grid-rows-6 gap-3 min-h-0">
          {cards.map((card) => {
            ...
            return (
              <div key={card.label} className="bg-surface border border-border rounded-xl px-4 flex items-center justify-between transition-all hover:bg-hover-bg min-h-0 overflow-hidden">
                <div className="min-w-0">
        ...
        <div className="col-span-6 row-span-4 bg-surface border border-border rounded-xl p-4 flex flex-col min-h-0">
          ...
          <div className="mt-3 pt-3 border-t border-border flex items-center justify-between flex-shrink-0">
            <div className="text-[9px] text-text-muted">Total no período: <span className="text-[#10b981] font-bold">{stats.tarefasAFazer + 25}</span></div>
            <div className="text-[9px] text-text-muted italic">Atualizado agora</div>
          </div>
        </div>

        {/* Distribuição (Pizza) - Ocupa 4/6 da altura */}
        <div className="col-span-3 row-span-4 bg-surface border border-border rounded-xl p-4 flex flex-col min-h-0">
        ...
        <div className="col-span-9 row-span-2 bg-surface border border-border rounded-xl p-4 flex flex-col min-h-0">
