    ...
    <div className="space-y-8">
      ...
      <div className="space-y-4">
        {loading ? (
          ...
          <div className="bg-background border border-border rounded-xl p-20 text-center">
            ...
            {novidades.map((n) => {
              ...
              return (
                <div 
                  ...
                  className="bg-surface border border-emerald-500/30 rounded-xl p-6 hover:border-emerald-500/60 transition-all shadow-lg relative overflow-hidden group cursor-pointer"
                >
                  {!lida && (
                  ...
                  <div className="flex items-start gap-4">
                    <div className={`w-12 h-12 rounded-xl flex items-center justify-center shrink-0 ${!lida ? 'bg-emerald-500/10 text-emerald-500' : 'bg-gray-500/5 text-text-disabled'}`}>
                      <Sparkles size={24} />
                    </div>
                    <div className="flex-1">
                      ...
                      <p className="text-sm leading-relaxed text-text-main line-clamp-2">
                        {n.descricao}
                      </p>
                    </div>
                  </div>
      ...
      {selectedNovidade && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-2xl bg-surface border border-emerald-500/30 rounded-xl shadow-2xl flex flex-col max-h-[90vh] overflow-hidden animate-in fade-in zoom-in duration-200">
            ...
            <div className="px-8 py-6 border-t border-emerald-500/10 flex justify-end">
              <button
                onClick={() => setSelectedNovidade(null)}
                className="px-6 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-text-main font-bold rounded-xl transition-all shadow-lg shadow-emerald-900/20"
              >
                Entendido
              </button>
            </div>
