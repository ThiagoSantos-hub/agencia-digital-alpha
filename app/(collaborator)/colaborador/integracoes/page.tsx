...
export default function IntegracoesColaboradorPage() {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto space-y-8">
      ...
      <section>
  <h2 className="text-[#1E293B] text-lg font-semibold mb-1">Meu WhatsApp</h2>
  ...
  <WhatsAppConnect />
      ...
      <section>
        <h2 className="text-[#1E293B] text-lg font-semibold mb-4">Minhas Conexões</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="rounded-xl p-4 flex flex-col justify-between gap-4"
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-[#1E293B] text-sm font-medium">OpenAI</p>
            ...
            <div className="flex gap-2">
              <input 
                ...
                className="flex-1 bg-white border border-[#E2E8F0] rounded-xl shadow-sm hover:shadow-md transition-shadow rounded-lg px-3 py-1.5 text-xs text-[#1E293B] focus:outline-none focus:border-[#00ff88]/50"
              />
              <button 
          ...
          <div className="rounded-xl p-4 flex flex-col justify-between gap-4"
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-[#1E293B] text-sm font-medium">ElevenLabs</p>
          ...
          <div className="rounded-xl p-4 flex items-center justify-between"
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-[#1E293B] text-sm font-medium">Google Ads Pessoal</p>
          ...
          <div className="rounded-xl p-4 flex items-center justify-between"
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-[#1E293B] text-sm font-medium">Google Drive</p>
          ...
          <div className="rounded-xl p-4 flex items-center justify-between"
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-[#1E293B] text-sm font-medium">Google Agenda</p>
          ...
          <div className="rounded-xl p-4 flex items-center justify-between"
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-[#1E293B] text-sm font-medium">Google E-mail</p>
          ...
          <div className="rounded-xl p-4 flex items-center justify-between"
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-[#1E293B] text-sm font-medium">Meta Ads Pessoal</p>
      ...
      <section>
        <h2 className="text-[#1E293B] text-lg font-semibold mb-2">Integrações da Agência</h2>
        <p className="text-xs mb-4" style={{ color: '#4a7a5a' }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="rounded-xl p-4 flex items-center justify-between"
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-[#1E293B] text-sm font-medium">WhatsApp (Agência)</p>
          ...
          <div className="rounded-xl p-4 flex items-center justify-between"
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-[#1E293B] text-sm font-medium">Meta Ads (Agência)</p>
                <p className="text-xs mt-0.5" style={{ color: '#00ff88' }}>
                  Ativo pela agência
                </p>
              </div>
