  ...
  return (
    <div className="min-h-full text-white">
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
          {alerts.map((alert) => (
            <div key={alert.id} className="bg-[#0a0a0f] border border-[#1a1a2e] p-6 rounded-2xl flex flex-col justify-between hover:border-[#10b981]/50 transition-colors group">
              <div>
            ...
            <form onSubmit={handleSave} className="p-6 space-y-4 max-h-[80vh] overflow-y-auto">
              ...
              <div className="flex gap-3 pt-4">
                ...
                <button
                  type="submit"
                  disabled={isSaving}
                  className="flex-1 bg-[#10b981] hover:bg-[#059669] text-white py-2.5 rounded-xl transition-colors text-sm font-bold flex items-center justify-center gap-2 disabled:opacity-50"
                >
