  ...
  return (
    <div className="min-h-full text-text-main">
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
          {alerts.map((alert) => (
            <div key={alert.id} className="bg-[#0a0a0f] border border-[#1a1a2e] p-6 rounded-xl flex flex-col justify-between hover:border-[#10b981]/50 transition-colors group">
              <div>
            ...
            <form onSubmit={handleSave} className="p-6 space-y-4 max-h-[80vh] overflow-y-auto">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <button
                      ...
                      className={`flex items-center justify-center p-2 rounded-xl border transition-all ${
                        formData.recebedor_tipo === 'privado' ? 'bg-[#10b981]/10 border-[#10b981] text-[#10b981]' : 'bg-[#050508] border-[#1a1a2e] text-text-muted'
                      }`}
                    >
                      <Smartphone size={14} />
                    </button>
                    <button
                      ...
                      className={`flex items-center justify-center p-2 rounded-xl border transition-all ${
                        formData.recebedor_tipo === 'grupo' ? 'bg-[#10b981]/10 border-[#10b981] text-[#10b981]' : 'bg-[#050508] border-[#1a1a2e] text-text-muted'
                      }`}
                    >
                      <Users size={14} />
                    </button>
              ...
              <div className="flex gap-3 pt-4">
                ...
                <button
                  type="submit"
                  disabled={isSaving}
                  className="flex-1 bg-[#10b981] hover:bg-[#059669] text-text-main py-2.5 rounded-xl transition-colors text-sm font-bold flex items-center justify-center gap-2 disabled:opacity-50"
                >
