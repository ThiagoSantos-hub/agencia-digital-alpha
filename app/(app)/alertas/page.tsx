            ...
            <div key={alert.id} className="bg-white border border-[#E2E8F0] rounded-xl shadow-sm hover:shadow-md transition-shadow p-6 rounded-2xl flex flex-col justify-between hover:border-[#6366f1]/50 transition-colors group">
              ...
              <div className="mt-6 pt-4 border-t border-[#1a1a2e] flex justify-between items-center">
                <button 
                  ...
                  className={`w-10 h-5 rounded-full relative transition-colors ${alert.ativo ? 'bg-[#6366f1]' : 'bg-gray-700'}`}
                >
            ...
            <form onSubmit={handleSave} className="p-6 space-y-4 max-h-[80vh] overflow-y-auto">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  ...
                  <input 
                    ...
                    className="w-full bg-[#050508] border border-[#1a1a2e] rounded-xl px-4 py-2.5 outline-none focus:border-[#6366f1] transition-colors text-sm"
              ...
              <div className="space-y-1.5">
                ...
                <textarea 
                  ...
                  className="w-full bg-[#050508] border border-[#1a1a2e] rounded-xl px-4 py-3 outline-none focus:border-[#6366f1] transition-colors text-sm min-h-[100px] resize-none"
