      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-12">
        ...
        {!isCreating && (
          ...
          >
            ...
            <span className="relative z-10">Nova Rotina</span>
          </button>
        )}
      </div>

      {/* ÁREA DE CRIAÇÃO - DESIGN GLASSMORPHISM */}
      {isCreating && (
        <div className="mb-16 bg-[#111]/80 backdrop-blur-xl border border-[#00ff88]/20 rounded-[2.5rem] p-8 shadow-2xl animate-in zoom-in-95 duration-500">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div className="space-y-8">
              <div className="group">
                <label className="block text-[10px] font-black text-gray-500 uppercase tracking-[0.2em] mb-3 group-focus-within:text-[#00ff88] transition-colors">Título da Rotina</label>
                <input
                  type="text"
                  value={newListTitle}
              ...
              <div>
                <label className="block text-[10px] font-black text-gray-500 uppercase tracking-[0.2em] mb-4">Dias de Reset Automático</label>
          ...
          <div className="mt-12 flex justify-end gap-6 pt-8 border-t border-white/5">
            <button onClick={resetCreateForm} className="text-xs font-black text-gray-600 hover:text-white uppercase tracking-widest transition-colors">Descartar</button>
            <button 
  ...
  return (
    <div className={`group relative bg-[#111] border rounded-[2rem] overflow-hidden transition-all duration-500 flex flex-col ${
      list.status === 'completed' 
        ...
        : 'border-[#1a1a1a] hover:border-[#00ff88]/30 hover:shadow-[0_20px_40px_rgba(0,0,0,0.4)]'
    }`}>
