...
const initialForm: FormState = {
  cpf: '', endereco: '', cidade: '', estado: '', nomeCompleto: '', email: '', telefone: '', aceite: false,
}

export default function PropostaCRMPage() {
      ...
      <div className="w-full max-w-lg">
        <div className="bg-surface border border-border rounded-xl p-8 shadow-sm">
          <div className="flex flex-col items-center text-center mb-6">
            ...
            <h1 className="text-text-main text-xl font-bold">Contrato — CRM Digital Alpha</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <input className={inputCls} value={form.cidade} onChange={(e) => set('cidade', e.target.value)} placeholder="Goiânia" />
              </div>
              <div>
