...
export const FEATURES: FeatureDef[] = [
  ...
  { key: 'clientes.exibir_campanhas', label: 'Vincular conta de anúncio e exibir em Campanhas', group: 'Clientes' },
  { key: 'campanhas.sincronizar_meta', label: 'Sincronizar Meta Ads manualmente', group: 'Campanhas' },
  { key: 'campanhas.metricas_personalizadas', label: 'Escolher métricas personalizadas', group: 'Campanhas' },
  { key: 'relatorios.envio_automatico', label: 'Envio automático agendado', group: 'Relatórios' },
  { key: 'relatorios.duplicar', label: 'Duplicar relatório', group: 'Relatórios' },
  { key: 'relatorios.historico', label: 'Histórico de envios', group: 'Relatórios' },
  ...
  { key: 'agenda.resumo_ia', label: 'Resumo da IA do dia', group: 'Agenda' },
  { key: 'agenda.enviar_email', label: 'Enviar e-mail direto pela Agenda', group: 'Agenda' },
  { key: 'tarefas.aviso_whatsapp', label: 'Aviso automático por WhatsApp', group: 'Tarefas' },
  { key: 'tarefas.anexo_drive', label: 'Anexar link do Google Drive', group: 'Tarefas' },
  { key: 'checklists.duplicar', label: 'Duplicar checklist', group: 'Checklists' },
  { key: 'checklists.reset_automatico', label: 'Reset automático por dia da semana', group: 'Checklists' },
  ...
  { key: 'contratos.link_publico', label: 'Link público pro cliente preencher', group: 'Contratos' },
  { key: 'contratos.reenviar', label: 'Reenviar contrato pendente', group: 'Contratos' },
  ...
  { key: 'colaboradores.financeiro_automatico', label: 'Lançar salário automaticamente no Financeiro', group: 'Colaboradores' },
  ...
  { key: 'integracoes.elevenlabs', label: 'Agente de voz ElevenLabs', group: 'Integrações' },
]
